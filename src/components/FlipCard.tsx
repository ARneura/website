...
export default function FadeInOnScroll() {
  ...
  return (
    <div
      className="w-full p-20 shadow-2xl bg-white service-mobile"
      id="services"
    >
      <div className="ml-28 pt-5 bg-white p-5 w-2/6 mb-5  rounded-3xl service-mobile service-ml">
        <h1 className="font-bold mb-3 text-3xl text-left text-blue-950">
          Services
        </h1>
        <h2 className="text-blue-950 text-left text-lg service-mobile hide-on-mobile">
      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 pb-8 text-blue-950">
          ...
          >
            ...
            <span className="text-left text-lg">
              Our team possesses a diverse range of skills, honed to meet all
              your project requirements. Whether its development, design, or any
              other aspect, we are fully equipped to handle every aspect. You
              can rest assured knowing that we have got you covered, ensuring
